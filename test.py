...
def nif_backlight(value):
    if value > 0:
        ...
        device.fx._lighting_dbus.setNone()

    print(device.fx._lighting_dbus.getEffectColors())
    print(device.fx._lighting_dbus.getEffect())

    device.fx._lighting_dbus.setKeyRow(1, 1)
    device.fx._lighting_dbus._getattr('set#Static')(COLOR[0], COLOR[1], COLOR[2])
    # device.fx._lighting_dbus.setCustom()
